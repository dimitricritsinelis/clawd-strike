...
Pilot: `ARCH_FRONTAGE_DYERS_ALLEY_WEST_N_BAY_WINDOW_S`; its mirror-position counterpart is a second placement of the same unmirrored model. Preserve original axes, sill and story binding; replace old complete screened-window visuals, not the wall. Dependencies: M02 and approval of the complete BLD_DYERS_HOUSE pilot; this screen pilot does not wait for P-WINDOW. Reuse its timber/frame craft in the later window families. Status **proposed**, nine total.
...
| door_storage_heavy | 1.35×.25×2.5 | 5 closed storage/work doors; full-width lintel and heavy hinges. | Caravan BAY_DOOR_S |
...
| window_dark_recess | .90×.28×1.25 | 14 framed closed dark windows, including five Dogleg windows. Retain complete sill and grille/backing; never a flat black route hole. | North house BAY_WINDOW_S |
...
| vent_service | .58×.18×.48 | 8 vents, including two Dogleg west; retain grille, deep closed shadow/backing and head. | DYE_WORKS BAY_VENT_AXIS |
...
A building composition is its ordered bays, shared finishes and assigned complete assemblies. It is not a new export of the entire street. Implement the named pilot component without rebuilding surrounding arches or cloning a whole building. Repeated parts belong to different uses through counts, spacing, height, quiet intervals and materials, not a new asset for every facade.
...
| Quiet return or rear face | Generic auto windows/doors/decorative fixtures on that named massing face only | Shell, grounded base, structural piers, roof/coping, other named public faces, collision |
